...
function AdjustOrder() {
  ...
  return (
    <div className="flex flex-col md:mx-4 mx-2 mt-3 min-h-screen bg-light dark:bg-dark">
      ...
      <div className="w-[100%] mb-4 bg-cardBgLight dark:bg-cardBgDark shadow-lg rounded-lg p-4 sm:p-6">
                      ...
                      >
                        {(provided, snapshot) => (
                          <div
                            ...
                            className={`relative p-2 rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 shadow-sm transition-all ${
                              snapshot.isDragging
        ...
        <div className="flex flex-col sm:flex-row sm:justify-end mt-4 gap-2">
          <button
            onClick={() => navigate(-1)}
            className="px-3 sm:px-4 py-1 sm:py-2 text-xs sm:text-sm font-medium text-white bg-gradient-to-r from-gray-500 to-gray-700 dark:from-gray-600 dark:to-gray-800 rounded-lg shadow-md hover:from-gray-600 hover:to-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-500"
          ...
          {existingFields.length > 0 && (
            <button
              ...
              disabled={isSaving}
              className={`px-3 sm:px-4 py-1 sm:py-2 text-xs sm:text-sm font-medium text-white bg-gradient-to-r from-blue-500 to-blue-700 dark:from-blue-600 dark:to-blue-800 rounded-lg shadow-md hover:from-blue-600 hover:to-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed`}
