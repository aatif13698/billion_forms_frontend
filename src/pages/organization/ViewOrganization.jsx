...
import { FaEnvelope, FaMapMarkerAlt, FaPhone, FaUsers, FaEdit, FaTrash, FaTrashAlt, FaRegEdit, FaRegUser, FaUser, FaSpinner, FaRegEye } from "react-icons/fa";
...
function ViewOrganization({ noFade }) {
                                            ...
                                            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center px-3 sm:px-4 py-2 sm:py-3 bg-custom-gradient-session-light dark:bg-custom-gradient-session-dark text-white dark:text-dark gap-2">
                                                ...
                                                <div className="flex gap-2">
                                                    <button
                                                            ...
                                                            setFormData2(
                                                                {
                                                                    session: item.name,
                                                                    for: item?.for,
                                                                    closeDate: common.formatDateToYYYYMMDD(item?.closeDate),
                                                        ...
                                                        className="flex items-center justify-center gap-2 px-2 sm:px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-green-500 to-green-700 dark:from-green-600 dark:to-green-800 rounded-lg shadow-md hover:from-green-600 hover:to-green-800 dark:hover:from-green-700 dark:hover:to-blue-900 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-green-500  sm:w-auto"
